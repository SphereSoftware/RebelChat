...
class NewSkypeForm extends Component {
  static
  propTypes = {
  ...
  saveTeam(e) {
    ...
    if (login && password) {
      ...
      teamLoader.connect({ type: 'Skype', login, password })
    }
  ...
  render() {
    return (
      <Wrapper>
        <h1>Enter your <b>Skype</b> credentials</h1>
        <form onSubmit={e => ::this.saveTeam(e)}>
          <section>
            <input type="text" name="login" className="native-key-bindings" placeholder="Enter your login" />
            <input type="password" name="password" className="native-key-bindings" placeholder="Enter your password" />
          </section>
          <section>
            <button type="submit">Connect</button>
            <p>
              If you have any questions you can read more <a tabIndex="-1" href="https://github.com/SphereSoftware/rebel-chat/wiki/Skype">here </a>.<br />
...
export default connect(mapStateToProps)(NewSkypeForm)
