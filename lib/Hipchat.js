...
// https://ecosystem.atlassian.net/wiki/display/HCDEV/HipChat+XMPP+Protocol+Documentation#HipChatXMPPProtocolDocumentation-Discovery
...
import { setAllUsers, addNewUser, addUsers } from './redux/modules/users'
...
export default class Hipchat {
  ...
  handleRecivedMessage(stanza) {
    if (stanza.attrs.type === 'groupchat') {
      ...
      // optimisation uncomment to skip self send messages
      // if (parseInt(senderId, 10) === this.userId && this.xmppRoomNickName === nik) {
      //   return
      // }
